import { BrandHeroEnterGate } from "@/components/brand-hero-enter-gate";
...
export async function BrandHero() {
  ...
  return (
    <BrandHeroEnterGate
      id="inicio"
      className="relative isolate flex flex-col overflow-hidden bg-navy text-white"
    ...
    >
      ...
      <div className="brand-hero-inner site-shell relative min-w-0 flex-1">
        <div className="brand-hero-columns">
          <div className="brand-hero-visual brand-hero-enter-logo flex min-w-0 justify-center">
          ...
          <div className="brand-hero-copy brand-hero-enter-copy flex min-w-0 flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <h1
              ...
              className="mt-4 w-full max-w-xl lg:max-w-2xl xl:max-w-[34rem]"
            >
